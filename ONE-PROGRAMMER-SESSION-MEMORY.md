...
- EXACT CODE HEAD → `f1fb809fb29e5b96952f3b4246cad3028e3d9853`.
...
- CURRENT RESUME POINTER → `f1fb809fb29e5b96952f3b4246cad3028e3d9853` → exact-head CI/Phase-F → first live/runtime failure → fresh certification.
