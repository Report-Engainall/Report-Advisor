...
- SHA → `b2e9014b7da308542fa3d89852e31bab37718113`
- HEAD → `b2e9014b7da308542fa3d89852e31bab37718113` on `main`.
...
- CURRENT RESUME POINTER → `<NEW_ATOMIC_SHA>` → fresh exact-head governance/quality/certification/browser evidence → authorized Phase-F restore-source credential → measured RPO/RTO/rollback → governed merge/final certification.
