...
- EXACT CODE HEAD → `0312d22046962cd5d8eaba785abd0b74cf509af7`.
...
- CURRENT RESUME POINTER → `0312d22046962cd5d8eaba785abd0b74cf509af7` → exact-head CI/Phase-F → first live/runtime failure → fresh certification.
