...
for(const token of ['fetchInventoryIntelligenceSource','applyReportMode','تفصيل للتحقيق','تجميع لفهم التعرض'])if(!page.includes(token))throw new Error(`missing UI contract: ${token}`);
...
if(!sidebar.includes('ذكاء المخزون'))throw new Error('missing sidebar entry');
