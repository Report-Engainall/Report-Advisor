...
assert.match(adapter,/status:'CONFIRMED'\|'CALCULATED'\|'INSUFFICIENT_DATA'/);
...
console.log('PASS top customers/products are read from canonical dashboard snapshot and tenant-derived');
