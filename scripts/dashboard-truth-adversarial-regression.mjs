...
// Current architecture owns top entities inside the canonical dashboard snapshot; the legacy split RPC is no longer part of the adapter contract.
...
console.log('PASS top customers/products remain canonical server-side in get_dashboard_snapshot');
