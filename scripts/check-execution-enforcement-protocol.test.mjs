...
assert.throws(() => validateCurrentHeadIndex(indexOnlyBoundary, 'cccccccccccccccccccccccccccccccccccccccc', 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', ['docs/MASTER_EXECUTION_INDEX.md', 'src/app.tsx']), indexBoundaryError);
...
assert.throws(() => validateCurrentHeadIndex(enforcementOnlyBoundary, 'cccccccccccccccccccccccccccccccccccccccc', 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', ['scripts/check-execution-enforcement-protocol.mjs', 'src/app.tsx']), indexBoundaryError);

console.log('PASS v3.5 enforcement adversarial test-of-test (explicit index-boundary rejection contract)');
