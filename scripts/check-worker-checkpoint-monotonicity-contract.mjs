...
const source = fs.readFileSync('src/lib/report-execution/checkpoint.ts', 'utf8');
...
if (!/advanceCheckpoint/.test(source)) throw new Error('checkpoint advancement implementation is missing');
