...
// Bind the remaining-work register to recovery concepts that are explicitly
// present in the authoritative index. Runtime RPO/RTO/DR proof remains a
// separate operational evidence requirement and is intentionally fail-closed.
