...
const assertions = [
  ...
  ['category profitability preserves unknown values', reports.includes('r.sales==null||r.profit==null') || reports.includes('c.margin_pct==null')],
  ...
  ['analytics tenant boundary is server-side', analytics.includes('current_company_id()') && analytics.includes('TENANT_CONTEXT_MISMATCH')],
