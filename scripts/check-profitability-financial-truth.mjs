...
if (/sum\(i\.quantity \* i\.cost_price\)/.test(sql)) throw new Error('profitability SQL contains invalid outer aggregate alias');
if (page.includes('grossProfit') && page.includes('categories.map')) throw new Error('active profitability page must not derive gross profit from display categories');
