...
validateCompactArtifact({
  ...
  scenario_count: 12,
  results: scenarios.map(s => ({ scenario_id: s.id, exact_head: '950e0882c5557211a621be09a82a53f578af9713', tenant: 'tenant-a', execution_start: '2026-09-15T00:00:00Z', execution_end: '2026-09-15T00:00:01Z', assertions: [] })),
