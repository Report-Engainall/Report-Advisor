...
const guards = [
  ...
  'check-adversarial-document-corpus-completeness.mjs',
  'check-adversarial-document-corpus-severity.mjs',
  'check-business-golden-corpus-tenant-integrity.mjs',
  'check-business-golden-corpus-adversarial-contract.mjs',
  'check-business-golden-corpus-truth-invariants.mjs',
  'check-business-golden-corpus-arithmetic.mjs',
  'check-business-golden-corpus-referential-integrity.mjs',
  'check-business-golden-corpus-row-shape.mjs',
  'check-business-golden-corpus-unique-identifiers.mjs',
  'check-business-golden-corpus-temporal-and-value-contract.mjs',
  ...
  'check-certification-runtime-test-wiring-contract.mjs',
];
for (const guard of guards) if (!workflow.includes(guard)) throw new Error(`CERTIFICATION_WORKFLOW_GUARD_MISSING:${guard}`);
console.log(`CERTIFICATION_BOUNDARY_WORKFLOW_COVERAGE_PASS:${guards.length}`);
