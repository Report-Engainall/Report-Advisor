...
for (const token of ['phase-f-live-resilience','phase-f-live-resilience-probes.mjs','if:']) if (!workflow.includes(token)) throw new Error(`Phase F workflow invariant missing: ${token}`);
