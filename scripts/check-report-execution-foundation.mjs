...
const files = {
  ...
  'supabase/migrations/20260907000000_harden_report_execution_claim_token.sql': ['returns jsonb','lease_expired_max_attempts','returning jsonb_build_object','return claimed_row','grant execute on function public.claim_report_execution_job(uuid,uuid,text,integer) to service_role'],
};
