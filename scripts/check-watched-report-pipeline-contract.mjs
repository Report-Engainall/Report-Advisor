...
const validateDmlBoundary=(candidate)=>{if(!candidate.includes(revoke))throw new Error('Watched direct-DML revoke missing');if(!candidate.includes(recorder))throw new Error('Watched recorder RPC grant missing');};
...
console.log('Watched reports + tenant-bound folder/file provenance + input invariants + canonical provenance binding + text-first fallback + direct-write boundary + master-plan contract: PASS');
