...
for(const token of ['selectedRoot','desktop-folder-watch:start\',()=>startWatch()','realpath(watchedRoot)','realpath(resolved)','relativePath'])if(!main.includes(token))throw new Error(`Missing native IPC boundary token: ${token}`);
