...
const decision = source.match(/return\s*\{\s*certified:\s*([^,\n]+),/s)?.[1] ?? '';
...
if (!/const\s+certificationBlockers\s*=\s*\[/s.test(source)) throw new Error('CERTIFICATION_BLOCKER_AGGREGATION_MISSING');
