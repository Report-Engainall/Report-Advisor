...
- Current owner-level candidate hardening is carried through PR #468 on `candidate/950e-scenario-hardening`.
- Certification boundary remains fail-closed until the authoritative index is explicitly rebound to the exact certified candidate.
