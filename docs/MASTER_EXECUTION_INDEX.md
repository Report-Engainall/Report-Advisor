...
- **Current code/test candidate:** `ed6e1ec21fa80b5dd519aa97f266f20436e78135` (current UI integration head; subsequent documentation-only binding remains governance-only).
