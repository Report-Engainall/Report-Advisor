...
- **Current code/test candidate:** `0bd58f4cbfb9f226392a358a919f6fb5d8433f49` (current UI integration head; subsequent documentation-only binding remains governance-only).
