...
- CURRENT_REPOSITORY_HEAD: `735fe9ac59a229da0717651133746aad6e5d46db` (governance-only descendant of the current code/test candidate).
- CURRENT_CODE_TEST_CANDIDATE: `f5a5097e6c093b0ed266b8143c3308e369d96ff3`.
- CURRENT_GOVERNANCE_HEAD: `f5a5097e6c093b0ed266b8143c3308e369d96ff3` (latest verified governance candidate; current repository head is a governance-only descendant). (current exact candidate for fresh certification).
