...
- Current code/test candidate: `7e19745f306a119512d153e05f8970408deb6028`.
...
- Structured PDF/file-engine regression was previously PASS on a predecessor candidate, but no historical PDF/OCR PASS is promoted to `7e19745f...`; the required fresh exact-head PDF/OCR run remains GitHub-bound because PC01 cannot expose the real CI secret safely through the local command boundary.
