...
- **Current code/test candidate:** `36515d26bea2c8b47fcdef4e5c4c00c1cf7105ab` (current UI integration head; subsequent documentation-only binding remains governance-only).
