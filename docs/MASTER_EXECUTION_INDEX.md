...
- **Current code/test candidate:** `e28353e26157409882283ea0c1d541db831813b9` (current UI integration head; subsequent documentation-only binding remains governance-only).
