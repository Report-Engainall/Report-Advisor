...
- **Current code/test candidate:** `407b85af2d833c9c17448234978a563def6a32aa` (current UI integration head; subsequent documentation-only binding remains governance-only).
