...
- **Current code/test candidate:** `bf0a4ae86ab82c9e429117551d4a717993c85f4c` (current UI integration head; subsequent documentation-only binding remains governance-only).
