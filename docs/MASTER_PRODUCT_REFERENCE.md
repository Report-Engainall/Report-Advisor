...
- Current code candidate: `0312d22046962cd5d8eaba785abd0b74cf509af7` (Phase-F migration restore repair).
...
- Current production runtime remains fail-closed because the latest READY production deployment serves older SHA `1d88b083c6c956abb42e2b2db2d5d816cb543344`, while the current code candidate is `0312d22046962cd5d8eaba785abd0b74cf509af7`. No current-head production proof or measured RPO/RTO/rollback is claimed.
