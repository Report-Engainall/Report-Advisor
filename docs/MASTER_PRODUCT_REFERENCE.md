...
- Current code candidate: `34f09de36582826e5e51bb47f268d4c2a8037244` (Phase-F migration restore repair).
...
- Current production runtime remains fail-closed because the latest READY production deployment serves older SHA `1d88b083c6c956abb42e2b2db2d5d816cb543344`, while the current code candidate is `34f09de36582826e5e51bb47f268d4c2a8037244`. No current-head production proof or measured RPO/RTO/rollback is claimed.
