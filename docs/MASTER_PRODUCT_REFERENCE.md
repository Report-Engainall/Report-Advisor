...
- Current code candidate: `2e9274e13c47085952ef701d2fa00c238d784277` (Phase-F migration restore repair).
...
- Current production runtime remains fail-closed because the latest READY production deployment serves older SHA `1d88b083c6c956abb42e2b2db2d5d816cb543344`, while the current code candidate is `2e9274e13c47085952ef701d2fa00c238d784277`. No current-head production proof or measured RPO/RTO/rollback is claimed.
