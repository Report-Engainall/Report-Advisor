...
| D-03 | التقارير الذكية | توليد تقرير من البيانات الفعلية | findings + evidence + drilldown | منفذ جزئيًا: Executive Decision Report read model + freshness/as-of + lifecycle quality؛ ما زال findings/evidence drilldown/PDF/E2E مطلوبًا |
