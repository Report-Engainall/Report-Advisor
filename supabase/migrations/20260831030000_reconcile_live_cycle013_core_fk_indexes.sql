-- Cycle 014: reconcile repository migration state with the verified live/staging
-- core FK performance indexes. These indexes are already present in the governed
-- database; IF NOT EXISTS makes this migration safe on that database and on a
-- fresh replay. No data or policy mutation is performed.
