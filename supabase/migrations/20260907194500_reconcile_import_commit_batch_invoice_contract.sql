-- Reconcile the batch import wrapper with the canonical sales-invoice RPC contract.
-- The canonical invoice RPC requires p_customer_name between p_customer_id and financial fields.
-- Keep this forward-only: do not recreate or preserve the incompatible legacy call shape.
