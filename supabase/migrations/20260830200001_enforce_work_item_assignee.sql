-- Cycle 013: enforce actor authorization on assigned decision work items.
-- Tenant and lifecycle checks remain canonical; an assigned item cannot be
-- completed by a different authenticated actor.
