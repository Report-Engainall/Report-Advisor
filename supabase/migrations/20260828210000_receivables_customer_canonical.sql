...
AS $$
WITH scoped AS (
  SELECT si.id, si.company_id, si.customer_id, c.name AS customer_name, si.invoice_number,
...
SELECT page.id, page.company_id, page.customer_id, page.customer_name, page.invoice_number,
