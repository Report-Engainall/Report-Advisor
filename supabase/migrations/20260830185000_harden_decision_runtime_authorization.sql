-- Cycle 013: close decision runtime authorization and lifecycle bypasses.
-- Self-approval is forbidden; completion requires an IN_PROGRESS work item and, when assigned,
-- the authenticated caller must be the assignee. All transitions remain tenant-authoritative.
...
BEGIN
  ...
  IF v_status <> 'IN_PROGRESS' THEN
    RAISE EXCEPTION 'WORK_ITEM_NOT_IN_PROGRESS';
  END IF;
