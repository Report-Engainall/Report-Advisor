-- Final ordering matters: this migration intentionally follows all 20260830
-- work-item lifecycle reassertions so provenance cannot be overwritten by a
-- later CREATE OR REPLACE FUNCTION in the same fresh-database replay.
