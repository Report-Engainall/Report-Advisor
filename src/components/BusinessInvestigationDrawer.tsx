            ...
            <section className="rounded-2xl border border-primary-200 bg-primary-50/45 p-4">
              ...
              <div className="mt-4 space-y-2">
                {target.actions.map(action => (
                  <Link key={action.path} to={action.path} onClick={onClose} className="flex items-center gap-3 rounded-xl border border-white bg-white p-3 transition hover:border-primary-300 hover:shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2">
