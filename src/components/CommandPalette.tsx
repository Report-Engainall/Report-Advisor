...
const COMMANDS: CommandItem[] = [
  ...
  { label: 'مركز العمليات', description: 'متابعة دورة الاستيراد وحالة العمل', path: '/work-center', keywords: ['work center', 'operations', 'jobs', 'operations center', 'عمليات', 'تشغيل'] },
  { label: 'مساحة القرار', description: 'الدليل والموافقة والتنفيذ والنتيجة', path: '/decision-experience', keywords: ['decision experience', 'decision', 'evidence', 'approval', 'قرار', 'دليل', 'موافقة'] },
  ...
  { label: 'تحليل الربحية', description: 'الإيراد والتكلفة والهامش مع قيود الحقيقة', path: '/reports/profitability', keywords: ['profitability', 'margin', 'profit', 'ربحية', 'هامش', 'ربح'] },
  ...
  { label: 'ذكاء المخزون', description: 'القيمة وإعادة الطلب ونقاط النقص', path: '/reports/inventory-intelligence', keywords: ['inventory intelligence', 'stock intelligence', 'مخزون', 'إعادة الطلب'] },
