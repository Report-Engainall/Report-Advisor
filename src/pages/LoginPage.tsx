          ...
          <div className="relative w-full max-w-md">
            ...
            <div className="rounded-[2rem] border border-ink-200/80 bg-white p-7 shadow-elevated sm:p-9">
              ...
              <form onSubmit={handleSubmit} className="mt-7 space-y-5">
                ...
                <button type="submit" aria-label="تسجيل الدخول" disabled={submitting} className="btn-primary w-full py-3">{submitting ? <Loader2 size={18} className="animate-spin"/> : <ArrowLeft size={18}/>} {submitting ? 'جارٍ التحقق...' : 'الدخول إلى مساحة العمل'}</button>
              </form>
