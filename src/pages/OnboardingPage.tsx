...
import { PageHeader, ErrorState, LoadingState, TruthRail } from '@/components/ui/States';
...
export function OnboardingPage() {
  ...
  return (
    <div dir="rtl" className="space-y-6">
      ...
      <TruthRail status={summary.action > 0 ? 'review' : summary.unknown > 0 ? 'limited' : 'live'} period={`${summary.ready} جاهزة · ${summary.action} تتطلب إجراء · ${summary.unknown} غير مثبت`} />
