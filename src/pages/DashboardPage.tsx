...
import {
  fetchCanonicalDashboardKPIs, fetchCanonicalMonthlyTrend, fetchCanonicalTopCustomers,
} from '@/lib/canonicalFinancialQueries';
import {
  fetchTopProducts, fetchCategoryBreakdown, fetchRecommendations, fetchAlerts, fetchAgingBuckets,
} from '@/lib/queries';
  ...
  const load = useCallback(async (silent = false) => {
    try {
      ...
      const [k, t, tc, tp, cat, recs, alts, ag] = await Promise.all([
        fetchCanonicalDashboardKPIs(), fetchCanonicalMonthlyTrend(trendMonths), fetchCanonicalTopCustomers(5), fetchTopProducts(5),
