...
import { EmptyState, ErrorState, LoadingState, TruthRail } from '@/components/ui/States';
...
export function RecommendationsPage() {
  ...
  return <div dir="rtl" className="space-y-6">
    <TruthRail status={items.length ? "live" : "limited"} period="التوصيات · المصدر التحليلي المعتمد" />
...
export function ForecastsPage() {
  ...
  return <div dir="rtl" className="space-y-6">
    <TruthRail status={items.length ? "live" : "limited"} period="التنبؤات · المصدر التحليلي المعتمد" />
