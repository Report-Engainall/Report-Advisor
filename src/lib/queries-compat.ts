 ...
 *
 * Dashboard business truth is owned by queries.ts -> dashboard-canonical.ts.
 * These wrappers intentionally preserve the historical import surface without
 * recreating a second aggregation engine or calling the secondary analytics RPC.
 */
export * from './queries';
