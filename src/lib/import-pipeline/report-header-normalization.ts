export const HEADER_SYNONYMS: Record<string,string> = {
  'رقم الصنف':'sku','كود الصنف':'sku','كود الصنف':'sku','رمز الصنف':'sku','رقم المادة':'sku','item code':'sku','item no':'sku','item number':'sku','sku':'sku','barcode':'barcode','باركود':'barcode','الباركود':'barcode',
