export const HEADER_SYNONYMS: Record<string,string> = {
  ...
  'رقم المورد':'supplier_id','كود المورد':'supplier_id','supplier code':'supplier_id','supplier number':'supplier_number','اسم المورد':'supplier_name','المورد':'supplier_name','supplier name':'supplier_name',
