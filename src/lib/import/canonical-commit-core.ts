...
function canonicalizeRow(entityType: 'products' | 'customers' | 'sales_invoices', row: ReconciledCanonicalImportRow): Record<string, unknown> {
  const d = row.data;
...
export async function commitImportBatchWithClient(
