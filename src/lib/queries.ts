...
function importCountOrNull(value: unknown, field: string): number | null {
  ...
  throw new Error('IMPORT_DATA_INVALID: ' + field + ' must be a non-negative integer or null');
}
