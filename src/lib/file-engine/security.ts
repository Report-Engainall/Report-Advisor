...
export async function checkDuplicate(hash: string, _legacyCompanyId?: string, _legacySupabase?: SupabaseLike): Promise<{ isDuplicate: boolean; existing: FileRecord | null }> {
