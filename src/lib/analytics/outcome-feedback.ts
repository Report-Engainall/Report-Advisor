...
import { validateOutcome, type DecisionOutcome } from './outcome-feedback-contract.ts';
export { recordOutcome, summarizeOutcomes, validateOutcome } from './outcome-feedback-contract.ts';
export type { DecisionOutcome, OutcomeLabel, OutcomeQuality } from './outcome-feedback-contract.ts';
