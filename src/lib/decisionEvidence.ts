import type { DecisionRecommendation, DecisionSignal } from './decisionEngine';
...
export interface EvidenceBackedDecision extends DecisionRecommendation {
