...
/**
 * Canonical semantic metric registry for all deterministic business metrics.
 * BUSINESS_METRICS remains the calculation definition SSOT; this registry adds
 * governance, freshness, evidence and consumer metadata without duplicating formulas.
 */
